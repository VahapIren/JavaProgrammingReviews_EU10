...
public class Maiinn {
    public static void main(String[] args) {
        ...
        switch (test) {
            ...
            case 2: // Test the File class
                Filee file = new Filee(input.nextLine(), input.nextDouble());
                file.openFile();
            ...
            case 3: // Test the Module class
                ...
                switch (input.nextLine()) {
                    ...
                    case "add":
                        ...
                        module.addFile(new Filee(input.nextLine(), input.nextDouble()));
                        System.out.println(module);
                        break;
                    case "remove":
                        module = new Module("Hello World", easyFiles());
                        module.removeFile(new Filee("Programming.pdf", 1.54));
                        System.out.println(module);
                        break;
                }
                break;
            case 4: // Test the Canvas class
                ...
                switch (input.nextLine()) {
                    ...
                    case "add":
                        canvas = new Canvas("Automation", easyQuizzes(), easyModules());
                        canvas.modules.get(0).addFile(new Filee(input.nextLine(), input.nextDouble()));
    ...
    public static ArrayList<Filee> easyFiles() {
        ArrayList<Filee> files = new ArrayList<>();
        files.add(new Filee("Day 2 Notes", 0.92));
        files.add(new Filee("Programming.pdf", 1.54));
        return files;
    }
    ...
    public static ArrayList<Module> easyModules() {
        ...
        modules.add(new Module("Html", new ArrayList<>(Arrays.asList(new Filee("html notes", 1.2)))));
        modules.add(new Module("Locators", new ArrayList<>(Arrays.asList(new Filee("Examples", 2.3), new Filee("Automation Intro.pdf", 3.1)))));
        return modules;
    }
}
